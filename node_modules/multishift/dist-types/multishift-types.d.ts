import type { DetailedHTMLProps, Dispatch, HTMLAttributes, HTMLProps, KeyboardEvent, MouseEvent, Ref } from 'react';
 ...
 */
type ActionType<ActionCreatorMap> = ActionCreatorMap extends ActionCreator<any> ? ReturnType<ActionCreatorMap> : ActionCreatorMap extends Record<any, any> ? {
