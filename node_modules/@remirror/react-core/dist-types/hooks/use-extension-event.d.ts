import { AnyExtensionConstructor, CustomHandler, GetCustomHandler, GetHandler, Handler, OptionsOfConstructor } from '@remirror/core';
/**
 ...
 * @internal
 */
export declare function useExtensionCustomEvent<Type extends AnyExtensionConstructor, Key extends keyof GetCustomHandler<OptionsOfConstructor<Type>>>(extension: Type, event: Key, memoizedCustomHandler: CustomHandler<GetCustomHandler<OptionsOfConstructor<Type>>[Key]>): void;
