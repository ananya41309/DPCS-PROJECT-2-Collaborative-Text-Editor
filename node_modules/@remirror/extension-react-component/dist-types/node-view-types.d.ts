...
import { Dynamic, EditorViewProps, GetFixed, NodeWithAttributesProps, ProsemirrorAttributes, Static } from '@remirror/core-types';
...
export interface ReactNodeViewProps extends EditorViewProps, NodeWithAttributesProps, CreateNodeViewProps {
    /**
